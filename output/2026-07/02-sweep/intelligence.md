...
- Capability progress in H1 2026 was steep and specifically agentic (autonomous task completion), while measurement itself became the bottleneck: benchmarks are saturating faster than they can be replaced.

Confirmed Developments:
- Agent benchmarks jumped: MLE-bench (ML engineering) from 17% (2024) to ~65% (early 2026); WebArena (realistic web tasks) from 15% (2023) to 74.3%; Cybench (professional CTF security tasks) at 93% (source: https://hai.stanford.edu/ai-index/2026-ai-index-report/technical-performance, 2026) (source: https://kili-technology.com/blog/ai-benchmarks-guide-the-top-evaluations-in-2026-and-why-theyre-not-enough, 2026)
...
Ledger Candidates:
- A frontier model scores above 50% on Humanity's Last Exam by mid-2027. Resolve by 2027-09. (motivated by: https://hai.stanford.edu/ai-index/2026-ai-index-report/technical-performance, 2026)
- Production failure rates improve materially: a credible audit reports frontier-model production success above 80% (vs ~67% in 2026) by mid-2027. Resolve by 2027-09. (motivated by: https://venturebeat.com/security/frontier-models-are-failing-one-in-three-production-attempts-and-getting-harder-to-audit, 2026)
- An independent, third-party evaluation body (not lab-funded) becomes a cited standard in at least one procurement framework or statute by mid-2027. Resolve by 2027-09. (motivated by: https://kili-technology.com/blog/ai-benchmarks-guide-the-top-evaluations-in-2026-and-why-theyre-not-enough, 2026)
