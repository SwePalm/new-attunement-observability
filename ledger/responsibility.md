# Signals ledger, responsibility

Format: see ledger/README.md. Append-only.

## Open claims

### responsibility-2026-02-03
...
- Grades:
 ...
 - 2026-08-04: open, contractual liability allocation is hardening (EU Product Liability Directive transposition due Dec 2026 is driving warranty, indemnity and modification clauses into AI contracts) but region-specific deployment configuration is not yet the norm and the horizon runs to 2029-02 (source: https://www.klgates.com/AI-Product-Liability-The-Next-Wave-of-Litigation-3-27-2026, Mar 2026)

### responsibility-2026-02-04
...
- Grades:
 ...
 - 2026-08-04: open, a peer-reviewed survey of 351 organisations finds formal AI governance roles unevenly distributed, usually placed below executive level with insufficient authority, and escalation pathways still uncommon (source: https://www.mdpi.com/2673-7116/6/2/18, Apr 2026)
...
- Status: decayed
- Grades:
 - 2026-08-04: decayed, the appellate pathway stalled because Garcia, the case that produced the AI-as-product holding, settled with Google and Character.AI in January 2026 before any Eleventh Circuit review of the certified question, and no appellate ruling on AI product classification has issued since; the March 2026 K.G.M. v. Meta verdict is trial level only (source: https://www.cnbc.com/2026/01/07/google-characterai-to-settle-suits-involving-suicides-ai-chatbots.html, Jan 2026)
...
- Status: confirmed
- Grades:
 - 2026-08-04: confirmed, Washington HB 2225 (signed 24 Mar 2026) regulates AI companion chatbots and creates a private right of action alongside Consumer Protection Act enforcement, and Oregon SB 1546 (signed 1 Apr 2026) adds statutory damages of $1,000 per violation, both well before the mid-2027 resolve-by (source: https://www.hunton.com/privacy-and-cybersecurity-law-blog/washington-state-enacts-law-regulating-ai-companion-chatbots-with-private-right-of-action, Mar 2026)
...
- Status: confirmed
- Grades:
  - 2026-09-25: confirmed, amazon.com Conditions of Use (last updated 14 Aug 2026) carry an "Agents" section defining an Agent as software acting "on behalf of, or at the instruction of" any person and requiring self-identification in the user agent string, but Wayback captures show the same Agent Terms already present in the 30 May 2025 revision, and the 14 Aug 2026 update changed them only in formatting, so the qualifying allocation predates the claim (source: https://www.amazon.com/gp/help/customer/display.html?nodeId=508088, Aug 2026)
